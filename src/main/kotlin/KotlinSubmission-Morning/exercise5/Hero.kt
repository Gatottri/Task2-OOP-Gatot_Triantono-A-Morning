...
class Hero {
    ...
    */
    fun lari() {
        checkHealth()
        println("$name lari sama ikura")
        health -= 2
    }
    fun makan() {
        checkHealth()
        println("$name makan mcd")
        health += 2
    }
    fun minum() {
        checkHealth()
        println("$name minum kopi")
        health += 2
    }
    fun lompat() {
        checkHealth()
        println("$name lagi melompat ke angkasa")
        health -= 2
    }
    fun duduk() {
        checkHealth()
        println("$name sedang duduk santai dengan Hawa")
        health += 1
    }
